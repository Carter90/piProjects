...
class RelayControl:
    def __init__(self):
        ...
        for pin in self._buttonList:  # set button pins to 3.3v
            ...
            GPIO.add_event_detect(pin, GPIO.RISING, callback=self.button_pressed, bouncetime=1000)
    ...
    def invert(self, relay_num):
        print("invert called")
        self._change_relay_state(relay_num, not self._relaystate[relay_num-1])
